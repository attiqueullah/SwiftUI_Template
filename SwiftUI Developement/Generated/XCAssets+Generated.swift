...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let alphaLogo = ImageAsset(name: "Alpha Logo")
    internal static let avatar = ImageAsset(name: "Avatar")
    internal static let bird = ImageAsset(name: "Bird")
    internal static let outflow = ImageAsset(name: "Outflow")
    internal static let rings = ImageAsset(name: "Rings")
    internal static let visa = ImageAsset(name: "Visa")
    internal static let birdLarge = ImageAsset(name: "birdLarge")
    internal static let card = ImageAsset(name: "card")
    internal static let noBird = ImageAsset(name: "noBird")
  }
